...
class TicketsController extends Controller
{
    ...
    public function Sendto(Request $request){
     ...
     Mail::send('emails.ticket', function ($message) {
        $message->from('olivehasan99@gmail.com', 'Suppot Ticket System');

        $message->to('email')->subject('There is a new ticket!');
    });
    ...
    Mail::send('emails.ticket', $data, function ($message) {
        ...
        $message->to('testpaper1323@gmail.com')->subject('There is a new ticket!');
    });
